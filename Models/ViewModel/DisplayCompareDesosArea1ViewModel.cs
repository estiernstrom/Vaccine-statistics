...
{
    public class DisplayCompareDesosArea1ViewModel
    {
        ...
        public DisplayCompareDesosArea1ViewModel(IndexFilterViewModel indexFilterViewModel, ScbDto scbDto)
        {
            DesoCode = [indexFilterViewModel.DesoCode1];
